...
(no axioms, no admitted proofs).  We state the epistemic status honestly:
...
\begin{itemize}
  ...
  \item \textbf{Dimensionality.}  The Maxwell-space derivation is a $1{+}1$
  dimensional skeleton; the 3D curl/divergence calculus and continuity are
  not formalized.
