...
螺旋模式。本文汇集在此基座上建立的统一链\cite{LiuXu,ProjectionPhysics}，并在 Lean 4 中全形式化
...
\end{equation}
海森堡不确定性关系\cite{Heisenberg1927}在其自然尺度上从螺旋几何涌现
...
扭量）才打开新通道，与泡利不相容原理\cite{Pauli1925}同构。
...
以上全部恒等经数值验证（N1--N29；Lean 4\cite{deMoura2015,mathlib2020}，机器精度）：Cauchy--Binet 链
